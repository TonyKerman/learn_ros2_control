...
#ifndef MY_HARDWAREINTERFACES__VISIBILITY_CONTROL_H_
#define MY_HARDWAREINTERFACES__VISIBILITY_CONTROL_H_
...
#endif  // MY_HARDWAREINTERFACES__VISIBILITY_CONTROL_H_
